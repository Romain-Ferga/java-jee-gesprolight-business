...
public class GpTechnicianServiceTest {
	...
	private IGpEmployeeService<GpTechnician> techService = new GpTechnicianServiceImpl();
	...
	public void testCreateTechnicianWithException() throws GesproBusinessException {
		...
		// Then
		Assert.assertTrue(actualMessage.contains("Un Technicien existe deja avec cet email"));
	}
	...
	public void testFindAllTechnicianWithSuccess() {
		...
		// When
		List<GpTechnician> techs = this.techService.findAll();
	...
	public void testFindByIdWithSuccess() {
		...
		// When
		GpEmployee tech = this.techService.findById(techId);
	...
	public void testDelete() {
		...
		// When
		this.techService.deleteById(techId);
		GpEmployee tech = this.techService.findById(techId);
	...
	public void deleteAllEntityAfter() {
		...
		this.techService.deleteById(this.techIdForAllTest);
		
		if(!Objects.isNull(this.createTechId)) {
			
			this.techService.deleteById(this.createTechId);
